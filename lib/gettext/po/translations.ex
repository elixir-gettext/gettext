defmodule Gettext.PO.Translations do
  ...
  def autogenerated?(%module{references: references} = _translation) when is_translation(module) do
    references != []
  end
  ...
  def protected?(_t, nil),
    do: false
  def protected?(%module{references: []}, _pattern) when is_translation(module),
    do: false
