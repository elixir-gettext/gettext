  ...
  describe "merge_template/2" do
    ...
    test "whitelisted translations are kept" do
      t1 = %Translation{
        ...
        msgstr: ["bar"],
        references: [{"foo.ex", 1}],
        flags: MapSet.new(["elixir-autogen", "elixir-format"])
      }
    ...
    test "matching translations are merged" do
      ...
      ts1 = [
        %Translation{
          ...
          references: [{"foo.ex", 2}],
          flags: MapSet.new(["elixir-format", "ex-autogen"]),
      ...
      ts2 = [
        ...
        %Translation{
          ...
          flags: MapSet.new(["elixir-autogen"])
        }
      ]

      assert Extractor.merge_template(%PO{translations: ts1}, %PO{translations: ts2}, []) ==
               %PO{
                 translations: [
                   %Translation{
                     msgid: ["matching autogenerated"],
                     references: [{"foo.ex", 3}],
                     flags: MapSet.new(["elixir-format", "elixir-autogen"]),
                     extracted_comments: ["#. Bar"]
                   },
                   %Translation{
