defmodule Gettext.ExtractorTest do
  ...
  test "merge_pot_files/2: reports the filename if syntax error" do
  ...
  test "merge_template/2: whitelisted translations are kept" do
    t1 = %Translation{msgid: ["foo"], msgstr: ["bar"], references: [{"foo.ex", 1}], flags: MapSet.new(["elixir-format"])}
  ...
  test "merge_template/2: matching translations are merged" do
    ts1 = [
      %Translation{msgid: ["matching"], references: [{"foo.ex", 2}]},
      %Translation{msgid: ["non-matching autogenerated"], flags: MapSet.new(["elixir-format"])},
    ]
    ts2 = [
      %Translation{msgid: ["non-matching non-autogenerated"]},
      %Translation{msgid: ["matching"], references: [{"foo.ex", 3}]},
    ]
